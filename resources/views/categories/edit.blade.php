...
<div class="p-6">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 dark:text-gray-400">Ubah informasi kategori</p>
        </div>
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="#3B82F6" 
                                   readonly
                                   x-data="{ value: '{{ old('color', $category->color ?? '#3B82F6') }}' }"
                                   x-model="value"
                    ...
                    <div>
                        ...
                        <input type="hidden" name="icon" id="icon" value="{{ old('icon', $category->icon ?? 'tag') }}">
